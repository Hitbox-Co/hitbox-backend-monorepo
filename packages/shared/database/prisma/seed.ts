...
const ARTISTS: Array<{
    ...
    collections: Array<{ name: string; description: string }>;
}> = [
        {
            ...
            collections: [
                { name: 'Signature Series', description: 'Hand-signed memorabilia from the band.' },
                { name: 'Misadventures Era', description: 'Collectibles from the 2016 album cycle.' },
            ],
        },
        {
            ...
            collections: [
                { name: 'Greatest Hits', description: 'Career-spanning collectible drop.' },
                { name: 'Warped Tour 2026', description: 'Relive the moments. Own the legacy.' },
            ],
        },
        {
            ...
            collections: [{ name: 'Championship 2026', description: 'Winners circle collectibles.' }],
        },
        {
...
const PRODUCTS: ProductSpec[] = [
    ...
    // ── NEW_RELEASE ─────────────────────────────────────────────────────
    { code: '200000010001', name: 'Warped Tour 2026 Commemorative Box', type: 'GROUP', category: 'GAME_BOX', genre: 'MUSIC', rarity: 'EPIC', status: 'NEW_RELEASE', price: 89.99, points: 4500, inventory: 1000, sold: 87, collection: 'Warped Tour 2026', images: 2, description: 'Relive the moments. Own the legacy.' },
    ...
    // ── TOP_CREATORS ────────────────────────────────────────────────────
    { code: '300000010001', name: 'PTV Acoustic Session Digital Asset', type: 'INDIVIDUAL', category: 'DIGITAL_ASSET', genre: 'MUSIC', rarity: 'RARE', status: 'TOP_CREATORS', price: 39.0, points: 2000, inventory: 500, sold: 260, collection: 'Signature Series', images: 1 },
